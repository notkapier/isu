 ...
 -->                        <li class="nav-item">
                    ...
                    <ul class="navbar-nav nav-flex-icons">
                        ...
                        <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true"
                          aria-expanded="false"><i class="fas fa-user mr-2"></i></a>
                        <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink">
                          <a class="dropdown-item nostyle" href="<?php echo base_url();?>home/login">Login</a>
                          <a class="dropdown-item nostyle" href="<?php echo base_url();?>home/register">Register</a>
                        </div>
                       </li>
                        <?php }?>
                        <?php if(!$this->session->userdata('username')==""){?>
                        <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true"
                          aria-expanded="false"><?php echo $this->session->userdata('username');?></a>
                        <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink">
                          <a class="dropdown-item nostyle" href="<?php echo base_url('home/organizationalchart')?>">Account Details</a>
                          <a class="dropdown-item nostyle" href="<?php echo base_url();?>home/logout">Logout</a>
                        </div>
                       </li>
                        <?php }?>
