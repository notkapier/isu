                            ...
                            <tr class="">
                                ...
                                <td class="text-center">
                                    ...
                                    <?php if($row->approved==0){?>
                                        <button name="<?php echo $row->id;?>" class="btnapprove green btn-sm white-text">approve</button>
                                    <?php }?>
                                    <?php if(($row->status==1) && ($row->approved==1)){?>
                                        <button name="<?php echo $row->id;?>" class="btndeactivate btn bg-orange btn-sm">deactivate</button>
                                    <?php }?>
                                    <?php if(($row->status==0) && ($row->approved==1)){?>
                                        <button name="<?php echo $row->id;?>" class="btnactivate btn bg-orange btn-sm">activate</button>
                                    <?php }?>
                                    </div>
                                </td>
                            </tr>
