    ...
    <script>
        ...
        $('#tablex tbody').on('click', '.btn-danger', function () {
            var id = this.name;
            swal({
        ...
        $('#tablex tbody').on('click', '.btndeactivate', function () {
            var id = this.name;
            swal({
                ...
                if (!isConfirm) return;
                $.ajax({
                    url: "<?php echo site_url('admin/changeData')?>/",
                    type: "POST",
                    data: {
                        id: id,
                        status:0,
        ...
        $('#tablex tbody').on('click', '.btnactivate', function () {
            var id = this.name;
            swal({
                title: "Activate User?",
                text: "asdasd",
                ...
                $.ajax({
                    ...
                    error: function(xhr, ajaxOptions, thrownError) {
                        swal("Error Activating!", "Please try again", "error");
                    }
                });
            });
        });
        ...
        $('#tablex tbody').on('click', '.btnapprove', function () {
            var id = this.name;
            swal({
                title: "Approve User?",
                text: "asdasd",
