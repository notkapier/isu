...
<div class="container" id="data_container">
    <div id="div_table" class="row">
        ...
        <div class="" id="div_form" style="display:none;">
            <?php $attributes = array('name'=>'dataform','id'=>'dataform','type'=>'postDataWithAttachment');?>
            <?php echo form_open_multipart('admin/postDataWithAttachment',$attributes);?>
                <input type="hidden" id="table" value="reference" name="table" />
                ...
                <div class="md-form" id="div_title">
                    ...
                    <label id="lbl_title" for="form1">Author</label>
                </div>

                <div class="md-form" id="div_title">

                </div>
                <select name="reference_type_id" id="reference_type_id" class="browser-default custom-select mb-2" style="width:20%;">
                        <?php foreach($reference_types as $row){?>
                        <option value="<?php echo $row->id;?>"><?php echo $row->reference_type;?></option>>
                        <?php }?>
                </select>   
